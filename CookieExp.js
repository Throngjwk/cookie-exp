...
var id = "?";
var name = "Cookie Exponential";
var description = "huh is demo?";
var authors = "nobody";
var version = 1;
...
var init = () => {
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(2, currency, new ExponentialCost(1e6, Math.log2(2.002)));
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(3, currency, new ExponentialCost(1e90, Math.log2(1e20)));
    ...
    ///////////////////////
    //// Milestone Upgrades
    theory.setMilestoneCost(new LinearCost(200, 200));
...
var getPublicationMultiplier = (tau) => tau.pow(1.111) / BigNumber.THREE;
